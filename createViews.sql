...
CREATE VIEW View_User_Information 
    AS SELECT Users.*,
        ...
        LEFT JOIN Cities AS Current_Cities ON User_Current_Cities.city_id = Current_Cities.city_id
        LEFT JOIN User_Hometown_Cities ON Users.user_id = User_Hometown_Cities.user_id
        LEFT JOIN Cities AS Hometown_Cities ON User_Hometown_Cities.city_id = Hometown_Cities.city_id
